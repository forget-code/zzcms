...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
	...
	<li><a href="zs_manage.php" target="frmright"><?php echo channelzs?>信息管理</a></li>
	<li><a href="dl_manage.php" target="frmright"><?php echo channeldl?>信息管理</a></li>
     </div>	
     <div id="left1" style="display:none"> 
	  <li><a href="zs_manage.php" target="frmright"><?php echo channelzs?>信息管理</a></li> 
	  <li><a href="dl_manage.php" target="frmright" ><?php echo channeldl?>信息管理</a></li>
	  <li><a href="dl_data.php" target="frmright" ><?php echo channeldl?>信息导入</a></li>
	  <li><a href="tag.php?tablename=zzcms_tagzs" target="frmright"><?php echo channelzs?>关键词管理</a></li>
	  <?php
	if (str_is_inarr(channel,'pp')=='yes'){
	?>
	  <li><a href="pp_manage.php" target="frmright">品牌信息管理</a></li> 
	<?php
	}
	if (str_is_inarr(channel,'job')=='yes'){
	?>  
	<li><a href="job_manage.php" target="frmright">招聘信息管理</a></li>
	<?php
	}
	if (str_is_inarr(channel,'zh')=='yes'){
	?>
	  <li><a href="zh_manage.php" target="frmright"  >展会信息管理</a></li> 
	<?php
	}
	if (str_is_inarr(channel,'zx')=='yes'){
	?>  
		<li><a href="zx_manage.php" target="frmright">资讯信息管理</a></li> 
         <li><a href="pinglun_manage.php" target="frmright">资讯评论管理</a></li> 
         <li><a href="tag.php?tablename=zzcms_tagzx" target="frmright">资讯关键词管理 </a></li> 
	<?php
	}
	if (str_is_inarr(channel,'wangkan')=='yes'){
	?>	 
		 <li><a href="wangkan_manage.php" target="frmright">网刊管理</a></li> 
	<?php
	}
	if (str_is_inarr(channel,'baojia')=='yes'){
	?>	 
		  <li><a href="baojia_manage.php" target="frmright" >报价管理</a></li>
	<?php
	}
	if (str_is_inarr(channel,'special')=='yes'){
	?>	  
		 <li><a href="special_manage.php" target="frmright">专题信息管理</a></li> 
	<?php
	}
	if (str_is_inarr(channel,'ask')=='yes'){
	?>
	 <li><a href="ask_manage.php" target="frmright">问答信息管理</a></li> 
	 <?php
	}
	?>
		<li><a href="ztliuyan_manage.php" target="frmright">展厅留言管理</a></li>
		<li><a href="usermessage.php" target="frmright">用户返馈管理</a></li> 
		<li><a href="licence.php" target="frmright">资质证书管理</a></li> 
		<li><a href="linkmanage.php" target="frmright">友情链接管理</a></li> 
		<li><a href="help_manage.php?b=2" target="frmright">公告信息管理</a></li>
		<li><a href="help_manage.php?b=1" target="frmright">帮助信息管理</a></li>
		<li><a href="domain_manage.php" target="frmright">展厅域名管理</a></li>
      </div>
	  
      <div id="left2" style="display:none"> 
	  <li><a href="class2.php?tablename=zzcms_zsclass" target="frmright"><?php echo channelzs?>/<?php echo channeldl?>类别管理</a></li> 
	 <?php
	if (str_is_inarr(channel,'zx')=='yes'){
	?>
	  <li><a href="class2.php?tablename=zzcms_zxclass" target="frmright">资讯类别管理</a></li>
	  <?php
	}
	if (str_is_inarr(channel,'special')=='yes'){
	?>
	   <li><a href="class2.php?tablename=zzcms_specialclass" target="frmright">专题类别管理</a></li> 
	   <?php
	}
	if (str_is_inarr(channel,'job')=='yes'){
	?>
	  <li><a href="class2.php?tablename=zzcms_jobclass" target="frmright">招聘类别管理</a></li>
	<?php
	}
	if (str_is_inarr(channel,'ask')=='yes'){
	?>
	  <li><a href="class2.php?tablename=zzcms_askclass" target="frmright">问答类别管理</a></li> 
	    <?php
	}
	if (str_is_inarr(channel,'zh')=='yes'){
	?>  
      <li><a href="class.php?tablename=zzcms_zhclass" target="frmright">展会类别管理</a></li> 
	  <?php
	}
	if (str_is_inarr(channel,'wangkan')=='yes'){
	?>
	  <li><a href="class.php?tablename=zzcms_wangkanclass" target="frmright">网刊类别管理</a></li>  
	  <?php
	}
	
	
	?>
	<li><a href="class2.php?tablename=zzcms_userclass" target="frmright">企业类别管理</a></li>
      <li><a href="adclass.php" target="frmright">广告类别管理</a></li> 
	<li><a href="class.php?tablename=zzcms_linkclass" target="frmright">友情链接类别管理</a></li> 
      </div>

      <div id="left3" style="display:none"> 
	   <li><a href="ad.php?do=add" target="frmright">添加广告</a></li>
        <li><a href="ad_manage.php" target="frmright">管理广告</a></li>
		<li><a href="adclass.php" target="frmright">类别设置</a></li>
		<li><a href="siteconfig.php?#qiangad" target="frmright">广告设置</a></li>
		 <li><a href="ad_user_manage.php" target="frmright">审请的广告</a></li>
		</div>

      <div id="left4" style="display:none"> 
		<li><a href="usermanage.php" target="frmright">用户管理</a></li>
		<li><a href="usergroup.php?do=show" target="frmright">用户组管理</a></li>
		<li><a href="siteconfig.php#usergr_power" target="frmright">个人用户权限管理</a></li>
	 	<li><a href="usernotreg.php" target="frmright">未进行邮箱验证的用户管理</a></li>
 		<li><a href="domain_manage.php" target="frmright">用户展厅域名管理</a></li>
		<li><a href="showbad.php" target="frmright">用户不良操作记录</a></li>
		
		<li><a href="usermessage.php" target="frmright">用户返馈信息管理</a></li>
        <li><a href="adminlist.php" target="frmright">管理员管理</a></li>
		<li><a href="admingroup.php" target="frmright">管理员组管理</a></li>
	</div>
      ...
      <div id="left5" style="display:none"> 
        ...
        <li><a href="uploadfile_nouse.php" target="frmright"> 清理无用的上传文件</a></li>
			...
			<li><a href="siteconfig.php#siteskin" target="frmright">网站风格设置</a></li>
			<li><a href="siteconfig.php#SiteInfo" target="frmright">网站基本信息设置</a></li>
			<li><a href="siteconfig.php#SiteOpen" target="frmright">网站运行状态设置</a></li>
			<li><a href="siteconfig.php#SiteOption" target="frmright">网站功能参数设置</a></li>
            <li><a href="about_manage.php" target="frmright">网站底部链接管理</a></li> 
			<li><a href="siteconfig.php#stopwords" target="frmright">限制字符设置</a></li> 
			<li><a href="showbad.php" target="frmright">限制来访IP管理</a></li>
            <li><a href="siteconfig.php#qiangad" target="frmright">广告设置</a></li>
			<li><a href="siteconfig.php#userjf" target="frmright">积分功能设置</a></li>
			<li><a href="siteconfig.php#UpFile" target="frmright">上传文件选项设置</a></li>
			<li><a href="siteconfig.php#addimage" target="frmright">添加水印功能设置</a></li>	 
			<li><a href="siteconfig.php#alipay_set" target="frmright">支付接口设置</a></li>	 
            <li><a href="siteconfig.php#sendmail" target="frmright">发邮件接口设置</a></li>
			<li><a href="siteconfig.php#sendsms" target="frmright">发手机短信接口设置</a></li>
			<li><a href="qqlogin_set.php" target="frmright">QQ互联接口设置</a></li> 
			<li><a href="ucenter_config.php" target="frmright">整合Discuz! Ucenter接口设置</a></li> 
			<li><a href="wjtset.php" target="frmright">文件头设置</a></li> 
			</div>
	...
	?>	
			...
			<li><a href="template.php" target="frmright">网站模板管理</a></li>
			<li><a href="template_user.php" target="frmright">用户展厅模板管理</a></li>
			</div>
