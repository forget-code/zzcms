...
?>
                    <td><table width="120" border="0" cellpadding="5" cellspacing="1">
                        <tr> 
                          <td height="100" align="center" bgcolor="#FFFFFF"><img src='../skin/mobile/<?php echo $file?>/image/mb.gif' width="120"  border='0'/></td>
                        </tr>
                        <tr> 
                          <td align="center" bgcolor="#FFFFFF"> <input name="skin" type="radio" id='<?php echo $file?>' value="<?php echo $file?>" <?php if($row["skin_mobile"]==$file){ echo"checked";}?>/> 
                            <label for='<?php echo $file.$row["skin_mobile"]?>'><?php echo $file?></label></td>
                        </tr>
                      </table></td>
                    <?php 
				  $i=$i+1;
