...
<div class="boxitem" id="A"> 
    <ul> 
	  	<li><a id="A2" href="#" onmouseover="javascript:doClick(this,'A','current')">网络图片</a></li>  
        <li><a id="A1" href="#" onmouseover="javascript:doClick(this,'A','current')" class="current">本地图片</a></li>                  
     </ul>
</div> 
