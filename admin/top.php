...
<title>管理员后台</title>
<style type="text/css">
body { margin:0px; background:#337ABB url("image/manage_top_bg.png"); font-size:12px;font-family: Arial, Helvetica, sans-serif,宋体,simsun; }
...
#tabs a {
  float:left;
  background:url("image/manage_tableft6.png") no-repeat left top;
  margin:0;
  padding:0 0 0 4px;
...
#tabs a span {
  float:left;
  display:block;
  background:url("image/manage_tabright6.png") no-repeat right top;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="200" align="center"><img src="image/manage_admin.png" /></td>
    <td><div id="tabs">
		<ul>
