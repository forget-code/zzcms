<?php
define('sqldb','test71');//数据库名
define('sqluser','root');//用户名
define('sqlpwd','root');//密码
define('sqlhost','localhost');//连接服务器,本机填(local)，外地填IP地址
define('zzcmsver','Powered By <a target=_blank style=font-weight:bold href=http://www.zzcms.net><font color=#FF6600 face=Arial>ZZ</font><font color=#025BAD face=Arial>CMS7.1</font></a>');//版本
