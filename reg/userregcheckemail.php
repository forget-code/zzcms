...
mysql_query("insert into zzcms_user (usersf,username,password,passwordtrue,comane,somane,phone,email,img,sex,regdate)values('$usersf','$username','$password','$passwordtrue','$comane','$somane','$phone','$email','/image/nopic.gif','1','".date('Y-m-d H:i:s')."')");		
//在用户配置表中增加新用户名记录
mysql_query("insert into zzcms_usersetting (username,skin,swf,daohang)values('$username','red2','6.swf','网站首页, 招商信息, 公司简介, 资质证书, 联系方式, 在线留言')");
//复制完后删除临时表中用户信息		
