...
while($row=mysql_fetch_array($rs)){	
	...
	mysql_query("delete from zzcms_pp where editor='".$editor."'");
	echo "此用户的品牌信息已被删除<br>";
	
	mysql_query("delete from zzcms_job where editor='".$editor."'");
	echo "此用户的招聘信息已被删除<br>";
	
	mysql_query("delete from zzcms_dl where editor='".$editor."'");
	echo "此用户的".channeldl."信息已被删除<br>";			
	
	mysql_query("delete from zzcms_zh where editor='".$editor."'");
	...
	mysql_query("update zzcms_ad set nextuser='' where nextuser='".$editor."'");
	...
	mysql_query("delete from zzcms_looked_person where username='".$editor."'");
	...
	mysql_query("delete from zzcms_usersetting where username='".$editor."'");
