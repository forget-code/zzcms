...
mysql_query("update zzcms_special set hit=hit+1 where id='$zxid'");
...
$smallclassname='';
$rs=mysql_query("select classname from zzcms_specialclass where classid='".$bigclassid."'");
$row=mysql_fetch_array($rs);
$bigclassname=$row["classname"];

if ($smallclassid<>""){
$rs=mysql_query("select classname from zzcms_specialclass where classid='".$smallclassid."'");
$row=mysql_fetch_array($rs);
