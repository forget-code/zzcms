<?php
define('sqldb','zzcms42');//数据库名
define('sqluser','root');//用户名
define('sqlpwd','root');//密码
define('sqlhost','localhost');//连接服务器,本机填(local)，外地填IP地址
define('zzcmsver','Powered By <a target=_blank style=font-weight:bold href=http://www.zzcms.net><font color=#FF6600 face=Arial>ZZ</font><font color=#025BAD face=Arial>CMS6.1</font></a>');//版本
...
define('pagesize_qt','5');//前台每页显示信息数
...
define('siteskin','red13') ;//网站电脑版当前使用模板
define('siteskin_mobile','mobile') ;//网站手机版当前使用模板
