...
$sql="select id,title,passed from zzcms_ztad where editor='".$username."' ";	
$sql=$sql.$sql2;
...
?>
          <tr class="bgcolor1" onMouseOver="fSetBg(this)" onMouseOut="fReBg(this)"> 
            <td width="222"><?php echo $row["title"]?>            </td>
	...
	if ($row["passed"]==1 ){ echo "<font color='green'>已审核</font>";}else{ echo "<font color=red>待审</font>";}
	  ?>            </td>
            <td width="55" align="center"> 
              ...
              <a href="advmodify.php?id=<?php echo $row["id"]?>&page=<?php echo $page?>&bigclassid=<?php echo $bigclassid?>">修改</a></td>
